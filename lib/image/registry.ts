...
export const IMAGE_MODELS: ImageModel[] = [
  ...
  // Kie.ai flagship image market — the most powerful models, one KIE_API_KEY.
  {
    ...
    tier: 'flagship',
    textFidelity: 'strong',
    notes: 'Google Nano Banana Pro — top-tier prompt adherence, text rendering, and photoreal detail. Best all-round ad still.',
  },
  {
    id: 'kie-seedream-v4',
    label: 'Seedream 4.0',
    ...
    tier: 'flagship',
    textFidelity: 'moderate',
    notes: 'ByteDance Seedream 4.0 — cinematic realism and strong composition for premium proof/founder stills.',
  },
  {
    ...
    tier: 'flagship',
    textFidelity: 'strong',
    notes: 'FLUX.1 Kontext Max — precise, editable photoreal generation with excellent typography control.',
  },
  {
    id: 'kie-gpt-image',
    label: 'GPT Image 2',
    ...
    tier: 'flagship',
    textFidelity: 'strong',
    notes: 'OpenAI GPT Image 2 — next-gen photorealism, sharp in-image text and instruction-following for headline/offer creatives.',
  },
  {
    id: 'kie-nano-banana',
    label: 'Nano Banana',
    ...
    tier: 'fast',
    textFidelity: 'moderate',
    notes: 'Google Nano Banana — fast, high-volume variant for quick creative variations.',
  },
  {
    id: 'fal-flux',
    label: 'FLUX.1',
    ...
    tier: 'flagship',
    textFidelity: 'weak',
    notes: 'Photoreal humans and scenes — one FAL_KEY, no per-model subscription. Great for realistic UGC and B-roll stills; weak at in-image text, so it renders scenes rather than headline creatives.',
  },
  {
    id: 'higgsfield-soul',
